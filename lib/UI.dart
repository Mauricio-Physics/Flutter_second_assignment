  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        child: Column(
            children: [
              column1(Provider.of<JokeModel>(context).value),
              MaterialButton(
                onPressed: (){setState(() {
                  Provider.of<JokeModel>(context, listen: false).API();
                });},
              ...
              MaterialButton(
                onPressed: (){
                  ...
                  // Provider.of<JokeModel>(context, listen: false).Add();
              ...
              MaterialButton(
                ...
                child: Text('Press to add to favourites'),
                color: Colors.purple,
              ),
              Center(
              ...
              MaterialButton(
                ...
                onPressed: () { launchUrl(Uri.parse(Provider.of<JokeModel>(context).url ?? 'https://api.chucknorris.io/jokes/random'));},
                color: Colors.green,
              ),
...
class _FavoritesScreenState extends State<FavoritesScreen> {
  @override
  Widget build(BuildContext context) {
    List<String?> Favories = Provider.of<JokeModel>(context).Favs;
    return Scaffold(
      appBar: AppBar(
        ...
        body: ListView.builder(
            ...
            itemBuilder: (_, int index){
              return ListTile(
                title: Text(Favories[index] ?? 'Ops!! NO JOKE'),
              );
            }
        )
    );
